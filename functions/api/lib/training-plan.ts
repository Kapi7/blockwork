...
export const BLOCKS: TrainingBlock[] = [
  ...
  // ═══════════════ BLOCK 1: Rebuild + Speed Introduction (Apr 14 - May 10) ═══════════════
  {
    ...
    endDate: '2026-05-10',
    stimulus: 'Sub-threshold cruise intervals (what he KNOWS). 4x1km → 5x1km → 3x2km progression at 3:50-3:55/km. Thursday alternates fartlek and bike. Long runs rebuild from 12km. Gym on Tue PM after track.',
    goals: [
      'Sub-threshold cruise intervals: 4x1km → 5x1km → 3x2km at 3:50-3:55/km',
      'Thursday alternates fartlek (wk1,3) and bike (wk2,4)',
    ...
    restrictions: [
      ...
      'Thursday alternates: wk1 fartlek, wk2 bike, wk3 fartlek, wk4 easy bike (recovery)',
    ...
    sessions: [
      ...
      { date: '2026-04-14', title: 'TRACK MAIN: 4x1km sub-threshold', workoutType: 3, description: `MAIN SET -- 4x 1km SUB-THRESHOLD (WHAT YOU KNOW)\n━━━━━━━━━━━━━━━━━━━━━━━━\n  * Target pace: 3:50-3:55/km (95-98%) -- sub-threshold cruise\n  * HR target: 162-170 bpm (Z4) by rep 3-4\n  * Recovery: 400m jog (~80-90sec)\n  * Effort: 6.5/10 -- controlled, familiar territory\n  * Total quality: 4km at pace\n\n  Your Strava data shows 6x1km at 3:35 in Oct at HR 162-179.\n  We're starting easier at 3:50-3:55 and building back.\n  Norwegian-style cruise intervals — your comfort zone.\n  Run relaxed. Tall posture. Quick feet. Breathe out hard.\n\nBAILOUT: If HR >175 OR pace slows 5+ sec/km on 2 consecutive reps, STOP.\n\nTrack shoes/racing flats.`, distancePlanned: 4000, totalTimePlanned: 0.3, tssPlanned: 45, structure: STRUCTURES.mainSubThreshold4x1km },
      ...
      { date: '2026-04-21', title: 'TRACK MAIN: 5x1km sub-threshold', workoutType: 3, description: `MAIN SET -- 5x 1km SUB-THRESHOLD (+1 REP)\n━━━━━━━━━━━━━━━━━━━━━━━━\n  * Target pace: 3:50-3:55/km (95-98%) -- sub-threshold cruise\n  * HR target: 164-172 bpm (Z4) by rep 3-5\n  * Recovery: 400m jog (~80-90sec)\n  * Effort: 7/10 -- same intensity, +1 rep vs last week\n  * Total quality: 5km at pace\n\n  Progression: 4x1km → 5x1km. Same controlled effort.\n  Your data shows you can hold 3:35 for 6 reps. 3:50-3:55 for 5 is conservative.\n  Build confidence. Negative split the set.\n\nBAILOUT: If HR >176 OR pace slows 5+ sec/km on 2 consecutive reps, STOP.`, distancePlanned: 5000, totalTimePlanned: 0.35, tssPlanned: 50, structure: STRUCTURES.mainSubThreshold5x1km },
      ...
      { date: '2026-04-28', title: 'TRACK MAIN: 3x2km sub-threshold', workoutType: 3, description: `MAIN SET -- 3x 2km SUB-THRESHOLD (LONGER REPS)\n━━━━━━━━━━━━━━━━━━━━━━━━\n  * Target pace: 3:50-3:55/km (95-98%) -- sub-threshold cruise\n  * HR target: 164-174 bpm (Z4) by rep 2-3\n  * Recovery: 400m jog (~90sec)\n  * Effort: 7/10 -- longer reps, same controlled intensity\n  * Total quality: 6km at pace\n\n  YOUR WHEELHOUSE: Strava shows 3x3km at 3:46-3:48 in Feb.\n  3x2km at 3:50-3:55 is well within your capacity.\n  Settle into rhythm early. These should feel smooth.\n\nBAILOUT: If HR >176 OR pace collapses, STOP.`, distancePlanned: 6000, totalTimePlanned: 0.4, tssPlanned: 60, structure: STRUCTURES.mainSubThreshold3x2km },
      ...
      { date: '2026-05-05', title: 'TRACK MAIN: 2x1km (recovery)', workoutType: 3, description: `MAIN SET -- 4x100m strides + 2x 1km (RECOVERY WEEK)\n━━━━━━━━━━━━━━━━━━━━━━━━\nSTRIDES: 4x 100m @ 3:40/km (build to 90%)\n  * Walk-back recovery between each\n\nMAIN: 2x 1km @ 3:48/km (96-100%)\n  * Recovery: 400m jog\n  * Effort: 6/10 -- relaxed, legs turning over\n  * Total quality: 2km\n\n  Recovery week. Keep legs sharp, don't accumulate fatigue.\n  Leave feeling fast, not tired.\n\nBAILOUT: If heavy, skip the 1km reps and just do strides.`, distancePlanned: 2400, totalTimePlanned: 0.25, tssPlanned: 30, structure: STRUCTURES.mainRecovery2x1km },
  ...
  // ═══════════════ BLOCK 2: Develop Speed (May 11 - Jun 7) ═══════════════
  {
    ...
    endDate: '2026-06-07',
    stimulus: 'Transition from sub-threshold to threshold. 6x1km at threshold, then 5x1km faster, 4x1.5km cruise, first 800m reps. Long runs reach 20km with fast finish. Alternating bike/fartlek Thursdays.',
    goals: [
    ...
    restrictions: [
      ...
      'Thursday alternates: wk5 bike, wk6 fartlek, wk7 bike, wk8 easy bike (recovery)',
      'Fartlek = continuous run, NO stopping between reps',
    ],
    sessions: [
      ...
      { date: '2026-05-12', title: 'TRACK MAIN: 6x1km @ 3:40-3:44', workoutType: 3, description: `MAIN SET -- 6x 1km CRUISE (TRANSITION BEGINS)\n━━━━━━━━━━━━━━━━━━━━━━━━\n  * Target pace: 3:40-3:44/km (100-102%) -- at threshold\n  * HR target: 168-176 bpm (Z4-Z5a) by rep 4-6\n  * Recovery: 400m jog (~90sec)\n  * Effort: 7.5/10\n  * Total quality: 6km at pace\n\n  TRANSITION: still long reps but now AT threshold, not below.\n  Your Oct 28 data: 6x1km at 3:34-3:37. We're coming back to that\n  but starting slightly slower (3:40-3:44) after the sub-threshold block.\n  Negative split: rep 6 fastest.\n\nBAILOUT: If HR >180 OR pace collapses on 2 consecutive reps, STOP.`, distancePlanned: 6000, totalTimePlanned: 0.45, tssPlanned: 65, structure: STRUCTURES.mainCruise6x1km },
      ...
      { date: '2026-05-19', title: 'TRACK MAIN: 5x1km @ 3:36-3:40', workoutType: 3, description: `MAIN SET -- 5x 1km (GETTING FASTER)\n━━━━━━━━━━━━━━━━━━━━━━━━\n  * Target pace: 3:36-3:40/km (102-104%) -- near 10K race pace\n  * HR target: 170-178 bpm (Z4-Z5a) by rep 3-5\n  * Recovery: 400m jog (~90sec)\n  * Effort: 8/10\n  * Total quality: 5km at pace\n\n  Faster than last week. Getting close to your Oct-Jan levels.\n  Your Oct 28 data: 6x1km @ 3:34-3:37. This is the doorstep.\n  Smooth, efficient running. Negative split the set.\n\nBAILOUT: If HR >180 OR pace collapses on 2 consecutive reps, STOP.`, distancePlanned: 5000, totalTimePlanned: 0.38, tssPlanned: 65, structure: STRUCTURES.mainCruise5x1km104 },
      ...
      { date: '2026-05-21', title: 'Fartlek 12km (8x3min)', workoutType: 3, description: `FARTLEK -- 12km continuous (8x3min hard)\n━━━━━━━━━━━━━━━━━━━━━━━━\n  * 3km warm-up @ 5:00/km (HR <150)\n  * 8× (3min hard @ 3:42/km / 1min easy @ 5:00/km)\n    — Hard = honest sub-threshold, "strong but controlled"\n    — HR target: 170-178 on hard portions\n    — Easy = 1min recovery jog (NOT walking)\n  * 2km cool-down @ 5:10/km\n\n━━━━━━━━━━━━━━━━━━━━━━━━\nTOTAL: ~12km | ~55min\nLonger surges, shorter rest. Building continuous quality.\nCONTINUOUS — do not stop between reps.\n\nBAILOUT: If HR >180 or pace collapses for 2 consecutive reps, jog home.`, distancePlanned: 12000, totalTimePlanned: 0.92, structure: STRUCTURES.fartlek8x3min },
      ...
      { date: '2026-05-26', title: 'TRACK MAIN: 4x1.5km @ 3:40-3:44', workoutType: 3, description: `MAIN SET -- 4x 1.5km CRUISE (YOUR STRONG SUIT)\n━━━━━━━━━━━━━━━━━━━━━━━━\n  * Target pace: 3:40-3:44/km (100-102%) -- at threshold\n  * HR target: 168-176 bpm (Z4-Z5a) by rep 3-4\n  * Recovery: 400m jog (~90sec)\n  * Effort: 7.5/10\n  * Total quality: 6km at pace\n\n  LONGER REPS at cruise pace — your STRONG suit.\n  Your Jan data: 5x1.6km @ 3:43-3:46. This matches exactly.\n  Settle in. These should feel rhythmic and controlled.\n\nBAILOUT: If HR >180 OR pace collapses on 2 consecutive reps, STOP.`, distancePlanned: 6000, totalTimePlanned: 0.45, tssPlanned: 65, structure: STRUCTURES.mainCruise4x1500m },
      ...
      { date: '2026-06-02', title: 'TRACK MAIN: 6x800m cruise', workoutType: 3, description: `MAIN SET -- 6x 800m CRUISE (FIRST 800m REPS!)\n━━━━━━━━━━━━━━━━━━━━━━━━\n  * Target pace: 3:36-3:40/km (102-104%) -- 2:53-2:56 per 800m\n  * HR target: 168-176 bpm (Z4-Z5a) by rep 4-6\n  * Recovery: 400m jog (~90sec)\n  * Effort: 7/10 -- recovery week volume but new rep length\n  * Total quality: 4.8km at pace\n\n  FIRST 800m reps! Introduced gently at cruise pace.\n  You've never done structured 800m track reps before.\n  This is about learning the rhythm, not pushing hard.\n  Recovery week: reduced volume (4.8km vs 6km).\n\nBAILOUT: If HR >178 OR pace collapses, STOP.`, distancePlanned: 4800, totalTimePlanned: 0.35, tssPlanned: 50, structure: STRUCTURES.mainTrack6x800mCruise },
  ...
  // ═══════════════ BLOCK 3: Race-Specific Sharpening (Jun 8 - Jul 5) ═══════════════
  {
    ...
    endDate: '2026-07-05',
    stimulus: 'Track reps dominate. 5x1km pushing toward 5K pace, first 12x400m, 6x1km at GOAL 5K pace (key assessment), 3x1km assessment. Fartlek dominates Thursday. Long runs peak at 22km with fast finish.',
    goals: [
    ...
    restrictions: [
      ...
      'Thursday: wk9 fartlek (Canova), wk10 fartlek (pyramid), wk11 fartlek (5K rhythm), wk12 bike (recovery)',
      'Fartlek = continuous run, NO stopping between reps',
    ],
    sessions: [
      ...
      { date: '2026-06-09', title: 'TRACK MAIN: 5x1km @ 3:32-3:36', workoutType: 3, description: `MAIN SET -- 5x 1km (PUSHING TOWARD 5K PACE)\n━━━━━━━━━━━━━━━━━━━━━━━━\n  * Target pace: 3:32-3:36/km (103-105%) -- approaching 5K pace\n  * HR target: 172-180 bpm (Z5a) by rep 3-5\n  * Recovery: 400m jog (~90sec)\n  * Effort: 8/10\n  * Total quality: 5km at pace\n\n  Track reps now dominate. Pushing toward 5K pace zone.\n  Your fastest 1km ever: 3:34 at HR 172. We're targeting 3:32-3:36.\n  This should feel harder than the cruise blocks but manageable.\n\nBAILOUT: If HR >182 OR pace collapses on 2 consecutive reps, STOP.`, distancePlanned: 5000, totalTimePlanned: 0.4, tssPlanned: 70, structure: STRUCTURES.mainTrack5x1km },
      ...
      { date: '2026-06-16', title: 'TRACK MAIN: 12x400m @ 84-86sec', workoutType: 3, description: `MAIN SET -- 12x 400m (FIRST 400m REPS!)\n━━━━━━━━━━━━━━━━━━━━━━━━\n  * Target pace: 3:30-3:35/km (105-107%) -- 84-86sec per 400m\n  * HR target: 175-182 bpm (Z5a-Z5b) by rep 6-12\n  * Recovery: 90sec jog (200m)\n  * Effort: 8/10\n  * Total quality: 4.8km at speed\n\n  FIRST 400m REPS! Week 10, not week 1. You're ready.\n  You've never done structured 400m track reps before.\n  12 reps at 5K pace zone — find the rhythm.\n  First 4 = settling in. Middle 4 = hold. Last 4 = finish strong.\n\nBAILOUT: If HR >184 OR pace >88sec on 2 consecutive reps, STOP.`, distancePlanned: 4800, totalTimePlanned: 0.4, tssPlanned: 70, structure: STRUCTURES.mainReps12x400m5kPace },
      ...
      { date: '2026-06-18', title: 'Fartlek 12km pyramid', workoutType: 3, description: `FARTLEK -- 12km pyramid (1-2-3-4-3-2-1 min)\n━━━━━━━━━━━━━━━━━━━━━━━━\n  * 3km warm-up @ 5:00/km (HR <150)\n  * PYRAMID: 1-2-3-4-3-2-1 min hard @ 3:30/km\n    with equal time easy between each\n    — Hard = 5K pace, feels like racing effort\n    — HR target: 175-182 on hard portions\n    — Easy = equal time jog\n  * 2km cool-down @ 5:10/km\n\n━━━━━━━━━━━━━━━━━━━━━━━━\nTOTAL: ~12km | ~55min\n16min of quality at 5K pace. CONTINUOUS — do not stop.\n\nBAILOUT: If HR >184 or pace collapses, cut the pyramid short.`, distancePlanned: 12000, totalTimePlanned: 0.92, structure: STRUCTURES.fartlekPyramid },
  ...
  // ═══════════════ BLOCK 4: Race + 10K Campaign (Jul 6 - Aug 23) ═══════════════
  {
    ...
    endDate: '2026-08-23',
    stimulus: '16x400m volume, 3km continuous race sim, 5K TT opener, 5K RACE Jul 25, post-TT recovery cruise, 4x2km THE 10K session, 10K taper, 10K RACE Aug 22.',
    goals: [
    ...
    sessions: [
      ...
      { date: '2026-07-07', title: 'TRACK MAIN: 16x400m @ 82-84sec', workoutType: 3, description: `MAIN SET -- 16x 400m (VOLUME UP — 400m ADAPTED)\n━━━━━━━━━━━━━━━━━━━━━━━━\n  * Target pace: 3:25-3:30/km (107-110%) -- 82-84sec per 400m\n  * HR target: 178-185 bpm (Z5a-Z5b) by rep 8-16\n  * Recovery: 75sec jog (200m) -- shorter rest\n  * Effort: 8.5/10\n  * Total quality: 6.4km at speed\n\n  400m volume UP now that you've adapted (introduced wk 10).\n  16 reps. First 4 = rhythm. Middle 8 = hold. Last 4 = character.\n  Metronomic — all within 82-84sec window.\n\nBAILOUT: If HR >186 OR pace >86sec on 2 consecutive reps, STOP.`, distancePlanned: 6400, totalTimePlanned: 0.5, tssPlanned: 85, structure: STRUCTURES.mainTrack16x400m },
