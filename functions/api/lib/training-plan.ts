...
export const BLOCKS: TrainingBlock[] = [
  ...
  // ═══════════════ BLOCK 1: Rebuild + Speed Introduction (Apr 14 - May 10) ═══════════════
  {
    ...
    sessions: [
      ...
      { date: '2026-04-23', title: 'Bike sweet spot 75min', workoutType: 2, description: `Bike sweet spot 75min\n━━━━━━━━━━━━━━━━━━━━━━━━\n  * 10min warm-up Z1\n  * 2×15min @ 88-93% FTP (264-279W) with 5min Z1 between\n  * 10min Z2 endurance\n  * 10min cool-down\n\nCOMPLEMENTS TUESDAY: Tue was 10×400m speed work.\nBike gives sustained aerobic stimulus without impact — different modality, same cardiovascular benefit.`, totalTimePlanned: 1.25, structure: STRUCTURES.bikeSweetSpot },
  ...
  // ═══════════════ BLOCK 2: Develop Speed (May 11 - Jun 7) ═══════════════
  {
    ...
    sessions: [
      ...
      { date: '2026-05-19', title: 'TRACK MAIN: 8x600m @ 2:10-2:13', workoutType: 3, description: `MAIN SET -- 8x 600m (BRIDGE FROM 400m TO 800m)\n━━━━━━━━━━━━━━━━━━━━━━━━\n  * Target pace: 3:36-3:41/km (102-104%) -- 2:10-2:13 per 600m\n  * HR target: 170-178 bpm (Z4-Z5a) by rep 5-8\n  * Recovery: 200m jog (~75sec)\n  * Effort: 7.5/10\n  * Total quality: 4.8km at pace\n\n  600m BRIDGE — the step between 400m and 800m.\n  You've done 400s for 4 weeks. Now hold it 50% longer.\n  Same pace, same effort, just a bit more sustained.\n  Smooth rhythm. Don't surge the first 200m.\n\nBAILOUT: If HR >180 OR pace collapses on 2 consecutive reps, STOP.\n\nTrack shoes. Manual lap each 600m.`, distancePlanned: 4800, totalTimePlanned: 0.38, tssPlanned: 60, structure: STRUCTURES.mainReps8x600m },
      ...
      { date: '2026-05-21', title: 'Bike over-under 60min', workoutType: 2, description: `Bike over-under 60min\n━━━━━━━━━━━━━━━━━━━━━━━━\n  * 12min warm-up Z1-Z2\n  * 4×(3min @ 91-100% FTP / 2min @ 60-70% FTP)\n  * 15min Z2 endurance\n  * 6min cool-down\n\nCOMPLEMENTS TUESDAY: Tue was 6×800m threshold cruise.\nBike over-unders teach the same lactate clearance without running stress. Impact-free intensity.`, totalTimePlanned: 1.0, structure: STRUCTURES.bikeOverUnder },
      ...
      { date: '2026-05-26', title: 'TRACK MAIN: 6x800m @ 2:52-2:56', workoutType: 3, description: `MAIN SET -- 6x 800m (EXTEND FROM 600m TO 800m)\n━━━━━━━━━━━━━━━━━━━━━━━━\n  * Target pace: 3:36-3:41/km (102-104%) -- 2:53-2:57 per 800m\n  * HR target: 170-178 bpm (Z4-Z5a) by rep 4-6\n  * Recovery: 400m jog (~90sec)\n  * Effort: 7.5/10\n  * Total quality: 4.8km at pace\n\n  800m reps — the step from 600m (last week) to 1km (Block 3).\n  Progression: 200 → 400 → 600 → HERE (800) → 1km.\n  Same pace as your 600s. Just hold it 33% longer.\n  Smooth, rhythmic. Don't surge early.\n\nBAILOUT: If HR >180 OR pace collapses on 2 consecutive reps, STOP.\n\nTrack shoes. Manual lap each 800m.`, distancePlanned: 4800, totalTimePlanned: 0.38, tssPlanned: 60, structure: STRUCTURES.mainTrack6x800mCruise },
  ...
  // ═══════════════ BLOCK 3: Race-Specific Sharpening (Jun 8 - Jul 5) ═══════════════
  {
    ...
    sessions: [
      ...
      { date: '2026-06-09', title: 'TRACK MAIN: 5x1km @ 3:34-3:38', workoutType: 3, description: `MAIN SET -- 5x 1km (FIRST 1km REPS — EXTEND FROM 800m)\n━━━━━━━━━━━━━━━━━━━━━━━━\n  * Target pace: 3:34-3:38/km (103-105%) -- approaching 5K pace\n  * HR target: 172-180 bpm (Z5a) by rep 3-5\n  * Recovery: 400m jog (~90sec)\n  * Effort: 8/10\n  * Total quality: 5km at pace\n\n  FIRST 1km REPS! The progression: 200→400→600→800→HERE.\n  Your fastest 1km ever: 3:34 at HR 172 (Oct 28).\n  We're targeting 3:34-3:38 — right at your proven ceiling.\n  5 reps to learn the distance. Quality over quantity.\n\nBAILOUT: If HR >182 OR pace collapses on 2 consecutive reps, STOP.\n\nTrack shoes. Manual lap each km.`, distancePlanned: 5000, totalTimePlanned: 0.4, tssPlanned: 65, structure: STRUCTURES.mainCruise5x1km104 },
      ...
      { date: '2026-06-11', title: 'Bike tempo intervals 60min', workoutType: 2, description: `Bike tempo intervals 60min\n━━━━━━━━━━━━━━━━━━━━━━━━\n  * 10min warm-up Z1\n  * 3×8min @ 78-85% FTP (234-255W) with 4min Z1 between\n  * 10min cool-down\n\nCOMPLEMENTS TUESDAY: Tue was 6×1km at 3:34 — hard threshold.\nBike tempo gives controlled aerobic work without running stress. Different modality, same purpose: raise the aerobic ceiling.`, totalTimePlanned: 1.0, structure: STRUCTURES.bikeTempoIntervals },
